...
# Making Structure/format issues to the original datasets
...
# Updating the active hours columns for the 'Tuesday' day of the week entrie
...
# Performing the 'Active Hours Processing' on the 'Friday' subset of the day of the week data filtered by 'location' (city)
friday_crct_processed_df_per_location <- process_active_hours_per_location(friday_crct_df)

#### #### #### #### #### #### #### #### 

# Performing the 'Active Hours Processing' on the 'Satday' subset of the day of the week data filtered by 'location' (city)
...
# Row binding the 'peak_users_dow_crct_procssed_df' created in the last step with  'wednesday' dataset together into a new
# data frame called 'peak users dow crct processed df'. Working towards creating a single dataframe.
peak_users_dow_crct_processed_df <- rbind(peak_users_dow_crct_processed_df, wednesday_crct_processed_df)

# Row binding the 'peak_users_dow_crct_procssed_df' created in the last step with  'thursnday' dataset together into a new
# data frame called 'peak users dow crct processed df'. Working towards creating a single dataframe. 
peak_users_dow_crct_processed_df <- rbind(peak_users_dow_crct_processed_df, thursday_crct_processed_df)

# Row binding the 'peak_users_dow_crct_procssed_df' created in the last step with  'friday' dataset together into a new
# data frame called 'peak users dow crct processed df'. Working towards creating a single dataframe. 
peak_users_dow_crct_processed_df <- rbind(peak_users_dow_crct_processed_df, friday_crct_processed_df)

# Row binding the 'peak_users_dow_crct_procssed_df' created in the last step with  'saturday' dataset together into a new 
# data frame called 'peak users dow crct processed df'. Working towards creating a single dataframe. 
...
#  theme(panel.spacing.y = unit(1, "in"))
